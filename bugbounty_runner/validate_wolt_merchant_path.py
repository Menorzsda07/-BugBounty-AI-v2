...
canonical = by_url["https://merchant.wolt.com/"]
double = by_url["https://merchant.wolt.com//"]
dot = by_url["https://merchant.wolt.com/./"]
...
result = {
    "program": "wolt",
    "candidate": "merchant path_normalization_diff root canonicalization",
...
open("wolt-merchant-path-validation.json", "w", encoding="utf-8").write(json.dumps(result, indent=2))
